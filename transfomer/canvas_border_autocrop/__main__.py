"""CLI for canvas border auto-crop detection."""
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(description="Detect axis-aligned canvas content rectangle")
    ...
    payload = {
        ...
        if out.canvas_content_rect_capture_px is None
        else list(out.canvas_content_rect_capture_px.as_tuple()),
