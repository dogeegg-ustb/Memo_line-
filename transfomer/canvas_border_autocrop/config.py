...
class DetectorConfig:
    ...
    # Workspace bg must look like a frame/bands around a canvas hole, not solid UI/canvas
    min_bg_hole_score: float = 0.18
    max_bg_bbox_fill_ratio: float = 0.55
    max_bg_search_border_touch: float = 0.70
