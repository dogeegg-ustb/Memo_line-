...
class DetectionStatus(str, Enum):
    ...
    NO_STABLE_BACKGROUND_MODEL = "NoStableWorkspaceBackground"
    NO_STABLE_WORKSPACE_BACKGROUND = "NoStableWorkspaceBackground"
    NO_CONNECTED_BACKGROUND = "NoConnectedBackgroundEvidence"
    NO_CONNECTED_BACKGROUND_EVIDENCE = "NoConnectedBackgroundEvidence"
    INSUFFICIENT_COMPLETE_SIDES = "InsufficientGeometry"
    INSUFFICIENT_GEOMETRY = "InsufficientGeometry"
    ENDPOINT_TRUNCATED = "EndpointTruncated"
    AMBIGUOUS_CANDIDATES = "AmbiguousCandidates"
    OUTER_BOUNDARY_NOT_SEPARABLE = "OuterBoundaryNotSeparable"
...
class DetectionOutput:
    ...
    observed_outer_sides: list[SemanticSide] = field(default_factory=list)
    closed_outer_sides: list[SemanticSide] = field(default_factory=list)
    # Architecture §6.2: expose background model for navigator reuse
    background_appearance_model: Optional[BackgroundAppearanceModel] = None
